...
export YAML=${YAML:-$BASE/configs/h200/a2_qwen3vl8b_full_4gpu.yaml}
...
export RUN_ID=${RUN_ID:-$(date +%y%m%d_%H%M%S)_qwen3vl8b_ttt_a2_full4}
export SESSION=${SESSION:-qwen3vl8b_ttt_a2_full4_${RUN_ID}}

exec bash "$BASE/scripts/h200/train_a2_a5.sh" a2 "$@"
