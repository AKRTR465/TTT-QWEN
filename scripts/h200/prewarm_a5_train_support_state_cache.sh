...
CACHE_ROOT="${TTT_PREPROCESS_CACHE_ROOT:-$PLAY_ROOT/projects/ttt_qwen/.cache/preprocess/260726_a5_support_aligned_v3_fp16}"
CACHE_NAMESPACE="${TTT_PREPROCESS_CACHE_NAMESPACE:-a5_support_aligned_train_support_statequery_fp16_v3}"
...
VENV="${TTT_H200_VENV:-$PLAY_ROOT/projects/ttt_qwen/.venv-h200-uv-py312-torch28}"
