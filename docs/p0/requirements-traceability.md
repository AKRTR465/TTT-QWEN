...
| ARCH-02-FLOW-001 | `2` | 总体数据流 | P3–P18 | `tests/test_fast_ttt.py`、`tests/test_state_encoder.py`、`tests/test_model.py`、`tests/test_p13_tiny_integration.py` | 已定义 | P3–P13 的 Qwen boundary、Query、Adapter、时空编码、soft Observation、hard Bank/FSM、Identity Bank、Retriever、Reader、Resampler、Composer 与单次 prefill 编排已验证；P14–P18 待实现 |
...
| ARCH-17-MODULE-001 | `17` | 推荐模块与职责 | P1、附录 A | `tests/test_v5_config_contract.py`、`tests/test_v5_module_skeletons.py`、`tests/test_model.py` | 已定义 | P1 职责及 P3–P13 的 Qwen/Query/Fast/Encoder/Head/Bank/Identity/Retriever/Reader/Composer/model 模块已验证；P14 及后续模块待实现 |
