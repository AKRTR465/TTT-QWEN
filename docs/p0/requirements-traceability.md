...
| ARCH-02-FLOW-001 | `2` | 总体数据流 | P3–P18 | `tests/test_fast_ttt.py`、`tests/test_end_to_end_demo.py` | 已定义 | P3 Qwen video boundary、P4 Query/Router/Resolver、P5 Adapter 已验证；P6–P18 待实现 |
...
| ARCH-06-BUDGET-001 | `6.6` | v5 参数预算 | P1、P5–P12 | `tests/test_v5_config_contract.py` 及逐模块参数预算测试 | 已定义 | P5 Adapter 精确预算 7,480,064/6,300,416/1,179,648 已验证；P6–P12 待实现 |
...
| ARCH-17-MODULE-001 | `17` | 推荐模块与职责 | P1、附录 A | `tests/test_v5_config_contract.py`、`tests/test_v5_module_skeletons.py`、P1 职责审计 | 已定义 | P1 职责、P3 `qwen_adapter.py`、P4 `query_encoder.py`、P5 `fast_ttt.py` 已验证；其余模块待实现 |
